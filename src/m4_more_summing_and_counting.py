...
def run_test_count_cosines_from():
    ...
    expected = 0
    answer = count_cosines_from(9, 8, 0.15)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(2, 6, 0.25)
    ...
    expected = 3
    answer = count_cosines_from(4, 9, 0.12)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 4
    answer = count_cosines_from(5, 8, -1.2)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.845635  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(5, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.309524  # This is APPROXIMATELY the correct answer.
